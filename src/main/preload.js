...
contextBridge.exposeInMainWorld('inkwell', {
  ...
  wg: {
    ...
    up:                   ()            => ipcRenderer.invoke('wg:up'),
    down:                 ()            => ipcRenderer.invoke('wg:down'),
    ...
    mountSamba:           (cfg)         => ipcRenderer.invoke('wg:mountSamba', cfg),
    unmountSamba:         ()            => ipcRenderer.invoke('wg:unmountSamba'),
    ...
    getSudoersInstructions: ()          => ipcRenderer.invoke('wg:getSudoersInstructions'),
  },
  ...
  exportDrawImage: (name, format, b64) => ipcRenderer.invoke('draw:exportImage', name, format, b64),
  ...
  testVpnSync: (cfg) => ipcRenderer.invoke('sync:testVpn', cfg),
